...
func (s *Vehicles) Batch(ctx context.Context, request operations.BatchRequest, opts ...operations.Option) (*operations.BatchResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, true, "BatchRequest", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}
...
func (s *Vehicles) LockStatus(ctx context.Context, request operations.GetLockStatusRequest, opts ...operations.Option) (*operations.GetLockStatusResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
	...
	res := &operations.GetLockStatusResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
...
func (s *Vehicles) Disconnect(ctx context.Context, request operations.DisconnectRequest, opts ...operations.Option) (*operations.DisconnectResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *Vehicles) Get(ctx context.Context, request operations.GetVehicleRequest, opts ...operations.Option) (*operations.GetVehicleResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *Vehicles) GetEngineOil(ctx context.Context, request operations.GetEngineOilRequest, opts ...operations.Option) (*operations.GetEngineOilResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *Vehicles) GetFuelTank(ctx context.Context, request operations.GetFuelTankRequest, opts ...operations.Option) (*operations.GetFuelTankResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *Vehicles) GetLocation(ctx context.Context, request operations.GetLocationRequest, opts ...operations.Option) (*operations.GetLocationResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *Vehicles) GetOdometer(ctx context.Context, request operations.GetOdometerRequest, opts ...operations.Option) (*operations.GetOdometerResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *Vehicles) GetPermissions(ctx context.Context, request operations.GetPermissionsRequest, opts ...operations.Option) (*operations.GetPermissionsResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *Vehicles) GetTirePressure(ctx context.Context, request operations.GetTirePressureRequest, opts ...operations.Option) (*operations.GetTirePressureResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *Vehicles) GetVin(ctx context.Context, request operations.GetVinRequest, opts ...operations.Option) (*operations.GetVinResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
		OperationID:    "getVin",
		OAuth2Scopes:   []string{},
...
// |`paging.count`|integer|The total number of elements for the entire query (not just the given page).|
// |`paging.offset`|integer|The current start index of the returned list of elements.|
func (s *Vehicles) ListVehicles(ctx context.Context, request operations.ListVehiclesRequest, opts ...operations.Option) (*operations.ListVehiclesResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
// |---	|---	|---	|
// |  status|   string|  If the request is successful, Smartcar will return “success” (HTTP 200 status).|
func (s *Vehicles) LockUnlock(ctx context.Context, request operations.LockUnlockRequest, opts ...operations.Option) (*operations.LockUnlockResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *Vehicles) SendDestination(ctx context.Context, request operations.SendDestinationRequest, opts ...operations.Option) (*operations.SendDestinationResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
