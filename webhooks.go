...
func (s *Webhooks) Subscribe(ctx context.Context, request operations.SubscribeRequest, opts ...operations.Option) (*operations.SubscribeResponse, error) {
...
// |---	|---	|---	|
// |  status|   string|  If the request is successful, Smartcar will return “success” (HTTP 200 status).|
func (s *Webhooks) Unsubscribe(ctx context.Context, request operations.UnsubscribeRequest, opts ...operations.Option) (*operations.UnsubscribeResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
