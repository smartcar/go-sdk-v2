...
func (s *Evs) GetBatteryCapacity(ctx context.Context, request operations.GetBatteryCapacityRequest, opts ...operations.Option) (*operations.GetBatteryCapacityResponse, error) {
...
func (s *Evs) GetBatteryLevel(ctx context.Context, request operations.GetBatteryLevelRequest, opts ...operations.Option) (*operations.GetBatteryLevelResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *Evs) GetChargingLimit(ctx context.Context, request operations.GetChargingLimitRequest, opts ...operations.Option) (*operations.GetChargingLimitResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *Evs) GetChargingStatus(ctx context.Context, request operations.GetChargingStatusRequest, opts ...operations.Option) (*operations.GetChargingStatusResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
//
// Returns the current charge limit of an electric vehicle.
func (s *Evs) SetChargingLimit(ctx context.Context, request operations.SetChargingLimitRequest, opts ...operations.Option) (*operations.SetChargingLimitResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
// |  `isPluggedIn` 	|   boolean	|  Indicates whether a charging cable is currently plugged into the vehicle’s charge port. 	|
// |   `state`	|   string	|   Indicates whether the vehicle is currently charging. Options: `CHARGING` `FULLY_CHARGED` `NOT_CHARGING`	|
func (s *Evs) StartStopCharge(ctx context.Context, request operations.StartStopChargeRequest, opts ...operations.Option) (*operations.StartStopChargeResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
