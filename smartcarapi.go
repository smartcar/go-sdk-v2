...
// SmartcarAPI - Smartcar API: # How do I use Postman with Smartcar?
...
type SDKOption func(*SmartcarAPI)

// WithServerURL allows the overriding of the default server URL
func WithServerURL(serverURL string) SDKOption {
	return func(sdk *SmartcarAPI) {
...
func New(opts ...SDKOption) *SmartcarAPI {
	sdk := &SmartcarAPI{
		sdkConfiguration: sdkConfiguration{
			Language:          "go",
