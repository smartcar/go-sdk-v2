...
func (s *Compatibility) ListCompatibility(ctx context.Context, request operations.ListCompatibilityRequest, opts ...operations.Option) (*operations.ListCompatibilityResponse, error) {
